...
def create_county_state_data():
   ...
   for state in all_stats_per_county:
      ...
      for county in all_stats_per_county[state]['stats']:
         ...
         for day in all_stats_per_county[state]['stats'][county]:
              
            for d in day:
               
               day[d]['deaths']  = day[d]['total_d'] - county_deaths
               day[d]['cases']   = day[d]['total_c'] - county_cases

               county_deaths =  day[d]['deaths']
               county_cases =  day[d]['cases']
