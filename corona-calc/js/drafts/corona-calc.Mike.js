...
function doSomethingWithJsonData(json_data ) {
   ...
   if (fr['14_day'].zero_day_met > 0) {
      fr_html += "<span class='good'><b>14-Day Trajectory</b>: zero day will occur " + fr['14_day'].zero_day_met.toString() + " days from today.</span><br>"
   }
   else {
      fr_html += "<span class='bad'><b>14-Day Trajectory</b>: herd immunity will occur " + fr['14_day'].herd_immunity_met.toString() + " days from today.</span><br>"
   }
   if (fr['7_day'].zero_day_met > 0) {
      fr_html += "<span class='good'><b>7-Day Trajectory</b>: zero day will occur " + fr['7_day'].zero_day_met.toString() + " days from today.<br></span>"
   }
   else {
      fr_html += "<span class='bad'><b>7-Day Trajectory</b>: herd immunity will occur " + fr['7_day'].herd_immunity_met.toString() + " days from today.</span><br>"
   }
   if (fr['3_day'].zero_day_met > 0) {
      fr_html += "<span class='good'><b>3-Day Trajectory</b>: zero day will occur " + fr['3_day'].zero_day_met.toString() + " days from today.</span><br>"
   }
   else {
      fr_html += "<span class='bad'><b>3-Day Trajectory</b>: herd immunity will occur " + fr['3_day'].herd_immunity_met.toString() + " days from today.</span><br>"
   }
   if (fr['exp'].zero_day_met > 0) {
      fr_html += "<span class='good'><b>Curve</b>: zero day will occur " + fr['exp'].zero_day_met.toString() + " days from today.</span><br>"
   }
   else {
      if (fr['exp'].herd_immunity_met > 0) {
      fr_html += "<span class='bad'><b>Curve</b>: herd immunity will occur " + fr['exp'].herd_immunity_met.toString() + " days from today.</span><br>"
      }
      else {
   ...
   document.getElementById("forecast").innerHTML= fr_html
